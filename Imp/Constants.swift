...
//  Imp
//
//  Created by Alexander Shalamov on 9/8/17.
...
class Constants {
  ...
  struct settings {
    static let suiteId = "imp.ftw" // App Group name, change with caution
    ...
    static let frameworksAboveHeaders = "framework_above_headers"
  }
